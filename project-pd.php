<?php
$title = "Angela Castro - Name of the Project"; 
...
require('includes/nav.php');
 ?>
        <main class="workProject">
            <div class="subheader">
                <h1 class='sectionTitle'>Work / Product Design /</h1>
            ...
            <section>
                ...
                <h2 class="h2-PD">Name of<br>this project</h2>
                <figure class="introImage">
                <img src="images/flowers.jpg" alt="" ></figure>
                <p class="intro-PD">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore aliqua.</p></div>
                <h3 class="h3-PD">A subtitle</h3>
                <p class="plainText">Arcu bibendum at varius vel pharetra vel. Morbi tristique senectus et netus et malesuada. Etiam non quam lacus suspendisse faucibus interdum posuere. Elit at imperdiet dui accumsan sit amet nulla facilisi. Arcu ac tortor dignissim convallis aenean et tortor at. Purus in mollis nunc sed id semper risus. Aliquet nec ullamcorper sit amet risus nullam eget felis eget. Lacus viverra vitae congue eu consequat ac felis.</p>
                <figure class="groupImage">
                <figure>
                <img src="images/converse.jpg" alt=""><img src="images/umbrella.jpg" alt=""></figure><figcaption><em>The caption for this image that explains everything.</em></figcaption></figure>
                <h3 class="h3-PD">Another subtitle</h3>
                <p class="plainText">Arcu bibendum at varius vel pharetra vel. Morbi tristique senectus et netus et malesuada. Etiam non quam lacus suspendisse faucibus interdum posuere. Elit at imperdiet dui accumsan sit amet nulla facilisi. Arcu ac tortor dignissim convallis aenean et tortor at. Purus in mollis nunc sed id semper risus. Aliquet nec ullamcorper sit amet risus nullam eget felis eget. Lacus viverra vitae congue eu consequat ac felis.</p>
                <figure class="singleImage">
                <img src="images/phone.jpg" alt="">
                <figcaption> <em>The caption for this image that explains everything.</em></figcaption>
                </figure>
            </section>
